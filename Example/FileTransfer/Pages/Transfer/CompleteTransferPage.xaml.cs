...
{
    /// <summary>
    /// Interaction logic for CompleteTransferPage.xaml
    /// </summary>
    public partial class CompleteTransferPage : Page
    {
        public CompleteTransferPage(CompleteTransferPageViewModel viewModel)
        {
            InitializeComponent();
